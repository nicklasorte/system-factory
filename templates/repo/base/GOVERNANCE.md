...
This repository participates in the spectrum-systems “czar” architecture. Canonical rules, schemas, and contracts live in `{{STANDARDS_REPO}}`; this repo consumes them and stays aligned.
...
- Upstream changes belong in `{{STANDARDS_REPO}}`; local changes should remain temporary and well-scoped.
